    ...
    <?php echo validation_errors(); ?>
      ...
      <table>
        <tr>
          <td>Id Nasabah</td>
          <td>:</td>
          <td><input type="text" name="id_pinjaman" value="<?php echo set_value('id_pinjaman'); ?>"></td>
        </tr>
        <tr>
          <td>Besar Pinjam</td>
          <td>:</td>
        ...
        <tr>
          <td>Id Anggota</td>
          <td>:</td>
          <td><input type="text" name="id_anggota" value="<?php echo set_value('id_anggota') ?>"></td>
        </tr>
        <tr>
          <td>Tanggal Pelunasan</td>
          <td>:</td>
          <td><input type="text" name="tanggal_pelunasan" value="<?php echo set_value('tanggal_pelunasan') ?>"></td>
        </tr>
